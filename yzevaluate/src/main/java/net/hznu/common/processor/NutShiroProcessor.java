package net.hznu.common.processor;

import net.hznu.common.base.Result;
import net.hznu.common.shiro.NutShiro;
import net.hznu.common.shiro.NutShiroInterceptor;
import net.hznu.common.shiro.NutShiroMethodInterceptor;
