...
import net.hznu.modules.services.sys.SysRoleService;
...
public class SysRoleController {
    ...
    @Ok("json")
    @RequiresAuthentication
    public Object roledata(@Param("uid") String unitid) {
        List<Map<String, Object>> tree = new ArrayList<>();
        Map<String, Object> obj = new HashMap<>();
        Cnd cnd = Cnd.NEW();
        if (!Strings.isBlank(unitid)) {
            cnd.and("unitid", "=", unitid).asc("name");
            List<Sys_role> list = roleService.query(cnd);
